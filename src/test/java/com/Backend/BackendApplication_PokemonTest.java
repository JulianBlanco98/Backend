...
class BackendApplication_PokemonTest {
	...
	void testMap_pokemonDTOTOEntity() {
		...
		List<Attack> expectedAttacks = pokemonEntity.getAttack();
		...
		List<Ability> expectedAbilities = pokemonEntity.getAbility();
		...
		List<CardsRelated> expectedCardsRelated = pokemonEntity.getCardsrelated();
	...
	void testMap_entityToPokemonDTO() {
	    ...
	    attack.setEffect(null);
	    attacks.add(attack);
	    pokemonEntity.setAttack(attacks);

	    // Habilidad
	    List<Ability> abilities = new ArrayList<>();
	    pokemonEntity.setAbility(abilities);

	    // Cards relacionadas
	    List<CardsRelated> relatedCards = new ArrayList<>();
	    pokemonEntity.setCardsrelated(relatedCards);
